...
/**
 * Represents the Moodle progress reset event.
 */
class progress_reset extends base {
    /**
    ...
    public static function get_name(): string {
        return get_string("eventprogressreset", "videoprogress");
    }
    ...
    public function get_description(): string {
        return get_string("eventprogressresetdescription", "videoprogress", (object)[
            "actorid" => $this->userid,
