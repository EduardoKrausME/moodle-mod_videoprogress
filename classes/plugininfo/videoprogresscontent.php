...
/**
 * Describes Video Progress synchronized content subplugins to Moodle's plugin manager.
 */
class videoprogresscontent extends base {
    /**
     * Allows removal only when no timeline point still uses the subplugin.
     *
    ...
    public function is_uninstall_allowed(): bool {
        ...
        return !$DB->record_exists("videoprogress_pointitems", ["plugin" => $this->name]);
    }

    /**
     * Returns the administration page that lists installed synchronized content formats.
     *
     * @return moodle_url Content subplugin management URL.
    ...
    /**
     * Loads an optional settings.php file supplied by the synchronized content subplugin.
     *
